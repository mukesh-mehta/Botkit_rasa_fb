...
controller.hears(['info-age'], 'direct_message,direct_mention,mention', rasa.hears, function (bot, message) {
  console.log(JSON.stringify(message))
  console.log('this is an age intent')
  bot.reply(message, 'This is an age intent')
})
controller.hears(['info-name'], 'direct_message,direct_mention,mention', rasa.hears, function (bot, message) {
  console.log(JSON.stringify(message))
  console.log('this is an age intent')
  bot.reply(message, 'This is an name intent')
})
controller.hears(['info-contact'], 'direct_message,direct_mention,mention', rasa.hears, function (bot, message) {
  console.log(JSON.stringify(message))
  console.log('this is an age intent')
  bot.reply(message, 'This is an contact intent')
})
